...
class Actors:
    ...
    """
    def __init__(self, initial_actors: Dict[Character, command_channel.ModelCommandChannel]):
    ...
    def add_actor(self, actor: Character, channel: command_channel.ModelCommandChannel) -> None:
    ...
    def get_command_channel(self, actor: Character) -> command_channel.ModelCommandChannel:
