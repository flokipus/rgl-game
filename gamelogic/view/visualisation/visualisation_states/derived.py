...
class Standing(VisualState):
    ...
    def enter(self, *, owner, old_state: VisualState) -> None:
        self.enter_time = globals.current_time_ms / 1000
        self.original_xy = owner.get_corner_xy()

    def update(self, *, owner) -> Union[None, VisualState]:
        current_time = globals.current_time_ms / 1000
    ...
    def exit(self, *, owner, next_state: VisualState) -> None:
...
class Moving(VisualState):
    ...
    def enter(self, *, owner, old_state: VisualState) -> None:
        self.time_begin = globals.current_time_ms / 1000 - 1/self.fps
